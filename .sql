...
select * from student as s join course as c on s.stdid=c.studentid where c.course_name='ASP.NET';
...
select * from student as s cross join course as c on s.stdid = c.studentid; 
